...
const Sign_Up = () => {
    ...
    const [role, setRole] = useState('paciente'); // Nuevo estado para el rol
    ...
    const register = async (e) => {
        ...
        const response = await fetch(`${API_URL}/api/auth/register`, {
            ...
            body: JSON.stringify({
                ...
                password: password,
                phone: phone,
                role: role, // Incluye el rol en el cuerpo de la solicitud
            }),
        });
        ...
        <div className="container" style={{ marginTop: '5%' }}>
            <div className="signup-grid">
                <div className="signup-form">
                    <form method="POST" onSubmit={register} role="form" aria-label="Sign Up Form">
